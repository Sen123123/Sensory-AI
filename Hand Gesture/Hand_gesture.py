...
if not cap.isOpened():
    print("Error: Could not excess webcam")
    exit()
...
while True:
    ...
    if results.multi_hand_landmarks and results.multi_handednesss:
        for idx, hand_landmarks in enumerate(frame, hand_landmarks, mp_hands.HAND_CONNECTIONS):
