...
mp_drawing = mp.soltions.drawing_utils

SCROLL_SPEED = 500
SCROLL_DELAY = 0.5
CAM_WIDTH, CAM_HEIGHT = 640, 480

def detect_gesture(landmark,handedness):
    fingers = []
    tips = [mp_hands.HandLandmark.INDEX_FINGER_TIP,mp_hands.HandsLandmark.MIDDLE_FINGER_TIP,mp_hands.HandLandmark.PINKY_TIP]
    ...
    if (handedness == "Right" and thumb_tip.x > thumb_ip.x) or (handedness == "Left" and thumb_ip.x):
        fingers.append(1)
...
print("GestureScroll Control Active\nOpen palm: Scroll Up\nFist: Scroll Down\nPress 'q' to exit")
...
while cap.isOpened():
    ...
    gesture, hands.process = "none", "Unknown"
